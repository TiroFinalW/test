...
public class HttpUtil {
    ...
    protected static final int connectionTimeout = 5000;

    protected static final int connectionRequestTimeout = 5000;

    protected static final int socketTimeout = 5000;

    protected static final Charset defaultCharset = Consts.UTF_8;
    // ---------------------------------------------------------------------
                ...
                .setRetryHandler(new HttpRequestRetryHandler() {
                    ...
                    public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
                        ...
                        if (executionCount <= maxRetry) {
                            try {
                                Thread.currentThread().sleep(executionCount * 500);
